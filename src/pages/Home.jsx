...
function Home() {
  ...
  const advantages = [
    ...
    },
    {
      ...
      description: 'Tirios handles all property management aspects, from maintenance to tenant relations.'
    }
  ];
  ...
  const investmentSteps = [
    {
      ...
      description: 'Connect your cryptocurrency wallet to Tirios to start investing.'
    },
    {
      icon: FaStore,
  ...
  const faqSections = [
    {
      ...
      questions: [
        {
          question: "What is Tirios?",
          answer: "Tirios is an innovative investment project dedicated to real estate. We allow clients to invest as little as $10 in investment properties, with the aim of building up regular income and/or savings."
        },
        {
        ...
        },
        {
          ...
          answer: "The Tirios Marketplace is our platform that allows Tirios community members to buy and sell NFTs among themselves.  It is the equivalent of a secondary market where investors can buy and sell NFTs among themselves. We may also cooperate with other marketplaces to allow anyone to choose their preferred marketplace."
        },
        {
        ...
        },
        {
          ...
          answer: "Tirios uses the most advanced technical means to ensure the confidentiality and security of transactions on the platform. "
        }
      ]
    }
  ];
    ...
    <div className="space-y-16">
      ...
      <section className="bg-secondary-900 text-white py-16">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">How Tirios Works</h2>
      ...
      <section className="bg-secondary-50 pt-16">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Why Choose Tirios</h2>
            ...
            <div className="mt-12 lg:mt-0 flex justify-center">
              <div className="bg-white rounded-lg shadow-xl p-8 max-w-sm w-full">
                ...
                <p className="mt-4 text-sm text-gray-500 text-center">
                  Already a member?{' '}
                  <a href="https://discord.gg/Tirios" className="text-indigo-600 hover:text-indigo-500">
                    Sign in
                  </a>
                </p>
              </div>
